...
def run_sampling(data_root,dataset_name, sparsity_percentage, results_folder, output_path):
    ...
    command = f"python main.py --name {name} --size_every {int(24*(12-(sparsity_percentage//100)))} --config_file {sample_config_path} --gpu 0 --sample 0 --milestone {checkpoint_number} --output {output_path}"
